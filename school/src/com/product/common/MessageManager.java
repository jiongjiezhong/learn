...
public class MessageManager {
	...
	static {
		...
		try {
			...
			// 数据库连接配置文件
			InputStream inputStreamJdbc = MessageManager.class.getClassLoader()
	...
	public static void main(String[] args) {
		Map<String, String> propertiesMap = MessageManager.getMessageManager()
				.getSystemProperties();
		System.out.println(propertiesMap
				.get(CommonConsts.MAP_KEY_BOOK_AHEAD_DAYS));
		System.out.println(MessageManager.getMessageManager().getMessage(
