...
public class MenuController extends BaseController {
	...
	public String initMenus() {
		...
		menu = getMenu(menuList, "电站管理列表");
		arr = new String[] { menu.getMenuId(), "电站管理列表新增", "1",
				"/admin/powerstation/addPowersUi.do", "psOperate" };
		saveNewMenu(arr);
		arr = new String[] { menu.getMenuId(), "电站管理列表修改", "2",
				"/admin/powerstation/changePowersUi.do", "psOperate" };
		saveNewMenu(arr);
		arr = new String[] { menu.getMenuId(), "电站管理列表删除", "3",
				"/admin/powerstation/removePower.do", "psOperate" };
		saveNewMenu(arr);
		arr = new String[] { menu.getMenuId(), "电站管理列表查看", "4",
				"/admin/powerstation/showPowers.do", "psOperate" };
		saveNewMenu(arr);
		arr = new String[] { menu.getMenuId(), "电站管理列表操作申请", "5",
				"/admin/powerstation/changePowersState.do", "psOperate" };
		saveNewMenu(arr);

		menu = getMenu(menuList, "电站待审批列表");
		arr = new String[] { menu.getMenuId(), "电站待审批列表驳回", "1",
