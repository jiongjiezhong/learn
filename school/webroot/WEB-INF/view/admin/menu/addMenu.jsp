...
<h2 class="contentTitle"><bmtag:message messageKey="菜单添加"/></h2>
<div class="pageContent">
<form id="addMenuForm" method="post" action="menu/saveMenu.do" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
			...
			<dl>
				...
				<dd>
					<input name="contents" value="${menu.contents}" type="text" class="required normal" size="25"
						maxlength="20" remote="<%=request.getContextPath()%>/common/checkUnique.do?tName=p_m_menu&tProperty=contents&property=contents"/>
				</dd>
			</dl>
			<dl>
				<dt>菜单链接：</dt>
