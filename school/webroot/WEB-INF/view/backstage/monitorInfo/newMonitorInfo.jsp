...
<form method="post" action="equipment/addMonitor.do" class="pageForm required-validate" 
	...
	<input type="hidden" value="6" name="userLevel" />
		<dl>
			...
			<dd>
				<input name="mCode" class="required" class="textInput" maxlength="20" style="width:130px;"/>
